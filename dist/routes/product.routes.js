...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new product_controller_1.default();
                return [4 /*yield*/, controller.createProduct(req.body)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.send(response)];
        }
...
router.put("/categories", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var controller, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new product_controller_1.default();
                return [4 /*yield*/, controller.addCategory(req.body)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.send(response)];
        }
